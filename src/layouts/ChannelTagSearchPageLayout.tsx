    ...
    <>
      ...
      <section className='section'>
        <div className='container'>
          ...
          <h2 className='title is-4 mb-4'>タグ: {tag}</h2>
          <ul>
...
export const pageQuery = graphql`
  query GetChannelTagSearch($channel: String!, $tag: String!) {
    posts: allMdx(
      filter: {
        frontmatter: { channel: { eq: $channel }, tags: { in: [$tag] } }
